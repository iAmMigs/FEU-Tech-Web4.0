...
#[ORM\Entity(repositoryClass: StudentJourneySpecialSoOrganizationRepository::class)]
#[ORM\Table(name: 'student_journey_special_so_organization')]
class StudentJourneySpecialSoOrganization
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?string $colorTheme = 'green'; 

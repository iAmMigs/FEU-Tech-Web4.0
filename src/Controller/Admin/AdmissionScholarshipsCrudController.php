...
class AdmissionScholarshipsCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return AdmissionScholarships::class;
    }
    ...
    {
        return $crud
            ->setPageTitle('index', 'Scholarships Page Settings')
            ->setPageTitle('edit', 'Edit Scholarships Page Settings');
    }
